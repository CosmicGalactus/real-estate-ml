...
class RealEstateKnowledgeBase:
    ...
    def __init__(self, db_path: str = "./chroma_db"):
        ...
        self.market_data = self.client.get_or_create_collection(
            name="market_data", metadata={"hnsw:space": "cosine"}
        )
    ...
    def add_data(self, items: List[Dict[str, Any]]):
        ...
        self.market_data.add(ids=ids, documents=texts, metadatas=metadatas)
    ...
    def search(self, query: str, top_k: int = 3) -> List[Dict[str, Any]]:
        ...
        """
        try:
            results = self.market_data.query(query_texts=[query], n_results=top_k)
